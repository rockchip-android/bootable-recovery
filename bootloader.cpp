...
static int get_bootloader_message_block_rk29(bootloader_message *out, const Volume* v);
static int set_bootloader_message_block_rk29(const bootloader_message *in, const Volume* v);
